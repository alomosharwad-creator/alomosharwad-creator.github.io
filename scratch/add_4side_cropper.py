...
old_modal_pattern = r'<!-- Lightbox Modal for Credential Viewer with Interactive Rotate & Crop Tools -->.*?</script>'

new_modal_html = '''<!-- Lightbox Modal for Credential Viewer with 4-Side Crop & Save Tools -->
            ...
            <div class="relative bg-white rounded-2xl max-w-5xl w-full max-h-[95vh] overflow-hidden shadow-2xl flex flex-col border border-gray-100">
                ...
                <div class="p-4 overflow-hidden flex items-center justify-center bg-gray-950 min-h-[380px] max-h-[65vh] relative">
                    <div id="modal-img-container" class="relative overflow-hidden flex items-center justify-center transition-all duration-300">
                        <img id="modal-img" src="" alt="Credential" class="max-h-[60vh] w-auto object-contain transition-all duration-200 shadow-xl rounded-sm">
                    </div>
                </div>
        ...
        <script>
            ...
            function openCredentialModal(imgSrc, title, issuer) {
                ...
                // Check if custom saved version exists in localStorage
            ...
            function renderEditedCanvas(callback) {
                ...
                tempImg.onload = function() {
                    ...
                    rotCtx.rotate(rad);
                    rotCtx.drawImage(tempImg, -iw / 2, -ih / 2);
                ...
                // Use original source if stored, else current
                const rawSaved = localStorage.getItem('saved_cert_' + currentImgSrc);
            ...
            function saveAndApplyModalImg() {
                renderEditedCanvas(function(canvas) {
                    ...
                    alert('Changes saved successfully! The updated certificate is now applied to your portfolio.');
                });
            }
...
print("Successfully injected 4-Edge Cropper & Persistent Save logic into index.html!")
