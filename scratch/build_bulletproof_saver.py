...
new_script_code = '''<!-- Lightbox Modal for Credential Viewer with 4-Side Crop & Save Tools -->
        <div id="credential-modal" class="fixed inset-0 z-50 hidden bg-black/85 backdrop-blur-md flex items-center justify-center p-2 sm:p-4 select-none">
            <div class="relative bg-white rounded-2xl max-w-5xl w-full max-h-[95vh] overflow-hidden shadow-2xl flex flex-col border border-gray-100">
                ...
                <div class="p-3 sm:p-4 border-b border-gray-100 flex items-center justify-between bg-gray-50/90">
                    <div>
                        <div class="flex items-center gap-2">
                            <span class="text-[10px] font-semibold px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-100 font-mono">BULLETPROOF 4-EDGE CROPPER</span>
                    ...
                    <div class="flex items-center gap-2">
                        <button onclick="saveAndApplyModalImg()" class="px-4 py-1.5 bg-emerald-600 hover:bg-emerald-500 text-white text-xs font-semibold rounded-lg transition flex items-center gap-1.5 shadow-md">
                ...
                <div class="p-3 border-t border-gray-100 bg-gray-50 flex items-center justify-between text-xs text-gray-500">
                    <span class="font-mono text-gray-400">INSTANT SAVE ACTIVE // REAL-TIME PERSISTENCE</span>
                    <div class="flex items-center gap-2">
                        <button onclick="saveAndApplyModalImg()" class="px-5 py-2 bg-emerald-600 hover:bg-emerald-500 text-white font-semibold rounded-full transition shadow-md flex items-center gap-1.5">
        ...
        <script>
            ...
            function saveAndApplyModalImg() {
                ...
                // Save parameters persistently to localStorage (Zero quota issues, 100% reliable)
                try {
                ...
                // Apply style transformations directly to matching card images in portfolio
                ...
                alert('✅ تم حفظ وتطبيق التعديلات بنجاح على البورتفوليو!');
            }
            ...
            // Restore all previously saved custom certificate configurations on page load
...
print("Successfully injected Bulletproof, Zero-Error 4-Edge Cropper & Save logic into index.html!")
